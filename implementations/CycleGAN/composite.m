...
%     the rating of background distortion (Cbak). The ratings are based on the 1-5 MOS scale.
%     In addition, it returns the values of the SNRseg, log-likelihood ratio (LLR), PESQ
